...
| 评估维度 | 原始基座 Base | 主线 PPO (Step 71) | 消融 GRPO (Step 50) | 消融 Exp 1 (强负惩罚) | 消融 Exp 2 (纯稀疏) |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **KodCode (200 题)** | 76.50% (153/200) | **82.00% (164/200)** 🏆 | 79.00% (158/200) | 77.50% (155/200) | 74.00% (148/200) |
| **HumanEval (164 题)** | 78.66% (129/164) | 82.93% (136/164) | **83.54% (137/164)** ⚡ | 78.66% (129/164) | **81.10% (133/164)** |
| **MBPP Sanitized (427 题)** | 73.30% (313/427) | **75.88% (324/427)** 🏆 | **75.88% (324/427)** 🏆 | 73.30% (313/427) | **75.41% (322/427)** |
| **全量 791 题总解决数** | 595 / 791 题 | **624 / 791 题** 🏆 | 619 / 791 题 | 597 / 791 题 | 603 / 791 题 |
| **全量 791 题宏观平均率** | **76.15%** | **80.27%** 🏆 | **79.47%** | **76.24%** | **76.23%** |
| **致命崩溃错误数** | 24 次 | 12 次 (-50%) | 18 次 | **仅仅 2 次 (-91.7%)** 🛡️ | **4 次 (-83.3%)** 🛡️ |
| **平均生成代码长度** | 382.1 tok | 379.7 tok | **192.4 tok (-49%)** | **203.3 tok (-47%)** | 359.5 tok (-5%) |
...
PPO-NegPenalty  : [==================== 76.24% ] (597 题通过, 致命报错骤降至 2 次, 代码仅 203 tok) 🛡️ 极致防御
PPO-SparseRLVR  : [==================== 76.23% ] (603 题通过, HumanEval 81.10%, MBPP 75.41%) 🔍 算法高泛化
```
