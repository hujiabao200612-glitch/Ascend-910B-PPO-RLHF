...
| **PPO-DenseR 50步 (Exp 5)** | **79.00% (158/200)** ⚡ | **84.15% (138/164)** 🏆 | 74.94% (320/427) | **77.88% (616/791)** 🥇 | **仅 2 次 (-91.7%)** 🛡️ | **136.8 tok (-64.2%)** ⚡ |
| **PPO-DenseR 71步 (Exp 5-Full)** | 77.00% (154/200) | **82.93% (136/164)** ⚡ | 74.94% (320/427) | **77.12% (610/791)** | **仅 2 次 (-91.7%)** 🛡️ | **209.9 tok (-45.1%)** |
...
* **实测成果**：
  ...
  2. **极简高效生成（174.9 Tokens，缩减 54.0% ⚡）**：平均生成长度超越 GRPO（192.4 tok），彻底攻克 PPO 样板膨胀难题；
  3. **防御与精简兼备（609 题 / 76.99%）**：致命崩溃追平历史最低纪录（仅 2 次，-91.7%），实现防御性与代码精简的完美统一！
