...
### 预期评测对比全景表（Hypothetical Evaluation Matrix）

| 实验对照组 | KodCode (200) | HumanEval (164) | MBPP (427) | 致命崩溃数 | 平均 Token 长度 | Critic 收敛用时 |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Exp 0 (Baseline)** | 82.00% | 82.93% | 75.88% | 12 次 | 379.7 | 54.37s / step |
| **Exp 1 (+NegPenalty)**| **83.50% ↑** | 83.10% | 76.20% | **≤ 6 次 ↓↓** | 365.0 | 48.20s / step |
| **Exp 2 (SparseRLVR)** | 79.50% ↓ | 82.50% | 74.90% | 16 次 | **210.4 ↓** | 初期方差大 |
| **Exp 3 (DiscreteBins)**| 82.50% | 83.20% | 76.00% | 10 次 | 320.1 | **45.10s / step ↓** |
| **Exp 4 (+LenEfficiency)**| 82.50% | **84.75% ↑↑** | **77.20% ↑** | 9 次 | **198.5 ↓↓** | 稳定平滑 |
