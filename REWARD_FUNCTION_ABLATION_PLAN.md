...
| 实验对照组 | 状态 | KodCode (200) | HumanEval (164) | MBPP (427) | 致命崩溃数 | 平均 Token 长度 | 单步平均耗时 |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Qwen2.5-7B (Base 基座)** | 基线 | 76.50% | 78.66% | 73.30% | 24 次 | 382.1 tok | - |
| **Exp 0 (Baseline 3-Tier)** | **已完成** | **82.00%** | 82.93% | **75.88%** | 12 次 (-50%) | 379.7 tok | 54.37s / step |
| **Exp 1 (+NegPenalty)** | **实测已出** 🌟 | **77.50%** | 78.66% | 73.30% | **仅仅 2 次！！(-91.7%)** 🛡️ | **203.3 tok (-46.8%)** ⚡ | 47.40s / step |
| **Exp 2 (SparseRLVR)** | **待起训** | 预期 79.50% | 预期 82.50% | 预期 74.90% | 预期 ~16 次 | 预期 ~210 tok | 预期 46.50s / step |
| **Exp 3 (DiscreteBins)** | 计划中 | 预期 82.50% | 预期 83.20% | 预期 76.00% | 预期 ~10 次 | 预期 ~320 tok | 预期 45.10s / step |
| **Exp 4 (+LenEfficiency)**| 计划中 | 预期 82.50% | 预期 84.75% | 预期 77.20% | 预期 ~9 次 | 预期 ~198 tok | 预期 47.00s / step |
