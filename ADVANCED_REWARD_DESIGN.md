...
通过在 Next-Gen 中协同引入 VeRPO 超线性加权、TIPS 连续势能与 DHRCL 三阶段退火，预期将在消融对比中达成以下系统性突破：

| 评估维度 / 指标 | 原始 Sparse (71步) | 当前 DenseR (50步巅峰) | 当前 DenseR (71步过平滑) | **Next-Gen 融合预期 (71步)** |
| :--- | :---: | :---: | :---: | :---: |
| **HumanEval Pass@1 (164题)** | 81.10% | 84.15% (历史纪录) | 82.93% | **$\ge$ 84.76% (139/164)** 🏆 |
| **MBPP Pass@1 (427题)** | 73.07% | 74.94% | 74.94% | **$\ge$ 75.88% (324/427)** 🏆 |
| **KodCode Pass@1 (200题)** | 80.00% | 79.00% | 77.00% (策略受损) | **$\ge$ 82.50% (165/200)** 🏆 |
| **KodCode Partial Pass (部分通过)**| 7.5% | 11.5% | 16.0% (局部躺平) | **$\le$ 8.0% (被成功转化为全通)** |
| **平均输出代码长度 (Tokens)** | 289.4 tok | 136.8 tok | 209.9 tok (防御膨胀) | **145 ~ 160 tok (紧凑优雅)** |
| **致命崩溃/死循环率 (Crashes)** | 24.1% | 2.0% | 2.0% | **$\le$ 1.5% (极致鲁棒)** |
| **全基准 Macro 平均准确率 (791题)** | 76.51% | 77.88% | 77.12% | **$\ge$ 79.20% (626/791) 🥇** |
